export const tr = {
    ru: {
      ...
      otherCurrenciesTitle: 'За этот период в других валютах', otherCurrenciesSwitch: 'Показать эту валюту', sharePdfReady: 'PDF готов — нажмите, чтобы отправить', sharePdfBtn: 'Отправить PDF', sharePdfBuilding: 'Готовлю PDF…', sharePdfFail: 'Не удалось создать PDF', periodToday: 'Сегодня', periodWeek: 'Неделя', periodMonth: 'Месяц', periodYear: 'Год', periodAll: 'Всё',
      ...
      shareReport: 'Поделиться PDF', shareTitle: 'Wallet — Отчёт',
      ...
      back: 'Назад', detailsShow: 'Детали', detailsHide: 'Скрыть детали', detType: 'Тип', detBase: 'Сумма без комиссии', detOriginal: 'Исходная сумма', detCard: 'Карта', detCounterCard: 'Карта получателя', detBalance: 'Остаток после операции', detRef: 'Номер операции', detTag: 'Метка', detSource: 'Источник', detSourceSms: 'SMS от банка', detSourceImport: 'Скан/импорт', detSourceManual: 'Внесено вручную', catDeleteMove: 'Удалить категорию «{name}»? В ней {n} опер. — они сами перейдут в подходящие категории (остальные — в «Другое»). Отменить можно одной кнопкой.', autoFixOrphans: 'Категории исправлены у {n} опер.', autoFixEdit: 'Ещё {n} опер. этого получателя: «{from}» → «{to}»', autoFixUndo: 'Отменить', catDeleteConfirm: 'Убрать категорию из списка? Уже внесённые операции останутся без изменений.',
      ...
      inboxCheck: 'Сохранить и проверить',
    ...
    uz: {
      ...
      otherCurrenciesTitle: 'Shu davrda boshqa valyutalarda', otherCurrenciesSwitch: 'Shu valyutani ko\'rsatish', sharePdfReady: 'PDF tayyor — yuborish uchun bosing', sharePdfBtn: 'PDF yuborish', sharePdfBuilding: 'PDF tayyorlanmoqda…', sharePdfFail: 'PDF yaratib bo\'lmadi', periodToday: 'Bugun', periodWeek: 'Hafta', periodMonth: 'Oy', periodYear: 'Yil', periodAll: 'Barchasi',
      ...
      shareReport: 'PDF ulashish', shareTitle: 'Wallet — Hisobot',
      ...
      back: 'Orqaga', detailsShow: 'Tafsilotlar', detailsHide: 'Yashirish', detType: 'Turi', detBase: 'Komissiyasiz summa', detOriginal: 'Dastlabki summa', detCard: 'Karta', detCounterCard: 'Oluvchi kartasi', detBalance: 'Amaliyotdan keyingi qoldiq', detRef: 'Amaliyot raqami', detTag: 'Belgi', detSource: 'Manba', detSourceSms: 'Bankdan SMS', detSourceImport: 'Skan/import', detSourceManual: 'Qo\'lda kiritilgan', catDeleteMove: '«{name}» kategoriyasi o\'chirilsinmi? Unda {n} ta amaliyot bor — ular mos kategoriyalarga o\'tadi (qolganlari — «Boshqa»ga). Bir tugma bilan bekor qilish mumkin.', autoFixOrphans: '{n} ta amaliyotning kategoriyasi tuzatildi', autoFixEdit: 'Shu oluvchining yana {n} ta amaliyoti: «{from}» → «{to}»', autoFixUndo: 'Bekor qilish', catDeleteConfirm: 'Kategoriya ro\'yxatdan olib tashlansinmi? Kiritilgan amaliyotlar o\'zgarishsiz qoladi.',
      ...
      inboxCheck: 'Saqlash va tekshirish',
    ...
    en: {
      ...
      otherCurrenciesTitle: 'Other currencies in this period', otherCurrenciesSwitch: 'Show this currency', sharePdfReady: 'PDF is ready — tap to send', sharePdfBtn: 'Send PDF', sharePdfBuilding: 'Preparing PDF…', sharePdfFail: 'Couldn\'t create the PDF', periodToday: 'Today', periodWeek: 'Week', periodMonth: 'Month', periodYear: 'Year', periodAll: 'All',
      ...
      shareReport: 'Share PDF', shareTitle: 'Wallet — Report',
      ...
      back: 'Back', detailsShow: 'Details', detailsHide: 'Hide details', detType: 'Type', detBase: 'Amount without fee', detOriginal: 'Original amount', detCard: 'Card', detCounterCard: "Payee's card", detBalance: 'Balance after', detRef: 'Reference', detTag: 'Tag', detSource: 'Source', detSourceSms: 'Bank SMS', detSourceImport: 'Scan/import', detSourceManual: 'Entered manually', catDeleteMove: 'Delete the category "{name}"? Its {n} transactions will move to matching categories (the rest to "Other"). You can undo with one tap.', autoFixOrphans: 'Categories fixed for {n} transactions', autoFixEdit: '{n} more from this payee: "{from}" → "{to}"', autoFixUndo: 'Undo', catDeleteConfirm: 'Remove this category from the list? Recorded transactions stay unchanged.',
    ...
    tr: {
      ...
      otherCurrenciesTitle: 'Bu dönemde diğer para birimleri', otherCurrenciesSwitch: 'Bu para birimini göster', sharePdfReady: 'PDF hazır — göndermek için dokunun', sharePdfBtn: 'PDF gönder', sharePdfBuilding: 'PDF hazırlanıyor…', sharePdfFail: 'PDF oluşturulamadı', periodToday: 'Bugün', periodWeek: 'Hafta', periodMonth: 'Ay', periodYear: 'Yıl', periodAll: 'Tümü',
      ...
      shareReport: 'PDF paylaş', shareTitle: 'Wallet — Rapor',
      ...
      back: 'Geri', detailsShow: 'Ayrıntılar', detailsHide: 'Gizle', detType: 'Tür', detBase: 'Komisyonsuz tutar', detOriginal: 'Özgün tutar', detCard: 'Kart', detCounterCard: 'Alıcı kartı', detBalance: 'İşlem sonrası bakiye', detRef: 'İşlem no', detTag: 'Etiket', detSource: 'Kaynak', detSourceSms: 'Banka SMS', detSourceImport: 'Tarama/içe aktarma', detSourceManual: 'Elle girildi', catDeleteMove: '"{name}" kategorisi silinsin mi? İçindeki {n} işlem uygun kategorilere taşınacak (kalanlar "Diğer"e). Tek dokunuşla geri alınabilir.', autoFixOrphans: '{n} işlemin kategorisi düzeltildi', autoFixEdit: 'Bu alıcıdan {n} işlem daha: "{from}" → "{to}"', autoFixUndo: 'Geri al', catDeleteConfirm: 'Kategori listeden çıkarılsın mı? Kayıtlı işlemler değişmez.',
      ...
      inboxCheck: 'Kaydet ve kontrol et',
