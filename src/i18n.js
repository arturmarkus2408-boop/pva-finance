export const tr = {
    ...
    tr: {
      ...
      catDeleteMove: '"{name}" kategorisi silinsin mi? İçindeki {n} işlem uygun kategorilere taşınacak (kalanlar "Diğer"e). Tek dokunuşla geri alınabilir.', autoFixOrphans: '{n} işlemin kategorisi düzeltildi', autoFixEdit: 'Bu alıcıdan {n} işlem daha: "{from}" → "{to}"', autoFixUndo: 'Geri al', catDeleteConfirm: 'Kategori listeden çıkarılsın mı? Kayıtlı işlemler değişmez.',
